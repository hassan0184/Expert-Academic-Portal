...
def adminprofile(request):
    ...
    if request.POST:
     ...
     obj.save()
        ...
        #     context={
        #        'labels_graph': labels_graph,'data_graph': data_graph
        #    }
            return render(request, 'adminprofile.html', {'dataa': fetch_data,'data': fetch_data,'user_data':data, 'ID': userid,'comment': comment,'COUNT':comment_count,'REPLY':replycomment,'admin':1 ,'labels_graph': labels_graph,'data_graph': data_graph})
