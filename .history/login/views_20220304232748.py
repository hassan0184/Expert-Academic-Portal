...
def adminprofile(request):
    ...
    if request.POST:
     ...
     obj.save()
            ...
            return render(request, 'adminprofile.html', {'dataa': fetch_data,'data': fetch_data,'user_data':data, 'ID': userid,'comment': comment,'COUNT':comment_count,'REPLY':replycomment,'admin':1,'labels': labels_graph,'data': data_graph })
